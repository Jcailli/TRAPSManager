...
public class CompetFFCKConnectActivity extends AppCompatActivity implements OnClickListener, IConnectedResult {
	...
	private final static String KEY_ADDRESS0 = "competffck_address0";
	private final static String KEY_ADDRESS1 = "competffck_address1";
	private final static String KEY_ADDRESS2 = "competffck_address2";
	private final static String KEY_ADDRESS3 = "competffck_address3";
	private final static String KEY_PORT = "competffck_port";
	private final static String KEY_FORWARD_PENALTY = "competffck_forwardpenalty";
	private final static String KEY_FORWARD_CHRONO = "competffck_forwardchrono";
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        connectButton = (Button)findViewById(R.id.buttonConnectCompetFFCK);
        connectButton.setOnClickListener(this);
        
        final EditText addressField0 = (EditText)findViewById(R.id.competffckAddress1);
        ...
        forwardPenalty = (CheckBox)findViewById(R.id.forwardPenaltyCompetFFCK);
        forwardPenalty.setChecked(settings.getBoolean(KEY_FORWARD_PENALTY, true));
        
        forwardChrono = (CheckBox)findViewById(R.id.forwardChronoCompetFFCK);
	...
	public void onClick(View v) {
		...
		// now try to connect
		// context, address, port, callback (connectedResult);
		CompetFFCKHelper.getInstance().connect(this, new InetSocketAddress(address, port), this);
		
	}

	public void connectedResult(int value) {
		if (value==0) {
			Toast.makeText(this, "Connecté à CompetFFCK", Toast.LENGTH_LONG).show();
			...
			Utility.alert(this, "Erreur de connexion", "Impossible de se connecter à CompetFFCK");
		}
