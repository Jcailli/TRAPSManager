...
FocusScope {
    ...
    property int _penaltyCellCount: isPatrolMode ? viewcontroller.gateCount * 3 : (isKayakCrossMode ? viewcontroller.kayakCrossPostCount + 2 : viewcontroller.gateCount)
    property int _bibCellWidth: displayTimeData?(isPatrolMode?fontSize*47.5+8:(isKayakCrossMode?fontSize*36+6:fontSize*36+6)):fontSize*13.5+3
